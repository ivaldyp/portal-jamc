...
<head>
    ...
    <link rel="icon" type="image/png" sizes="16x16" href="{{ ('/pengamanan/public/img/photo/bpad-logo-05.png') }}">
        ...
        <nav class="navbar navbar-default navbar-static-top m-b-0">
            <div class="navbar-header">
                <div class="top-left-part">
                    <!-- Logo -->
                    <a class="logo" href="/pengamanan/home">
                        <span class="hidden-sm hidden-md hidden-lg"><img width="50%" src="{{ ('/pengamanan/public/img/photo/bpad-logo-05.png') }}"></span>
                        <span class="hidden-xs"><img width="20%" src="{{ ('/pengamanan/public/img/photo/bpad-logo-000.png') }}"><strong>BPAD</strong>
                        </span>
                    </a>
                </div>
                <!-- /Logo -->
