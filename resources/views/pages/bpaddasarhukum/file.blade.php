                    	...
                    	<div class="panel-wrapper collapse in">
                            <div class="panel-body">
                            	<div class="row " style="margin-bottom: 10px">
                            		@if ($access['zadd'] == 'y')
                        			<div class="col-md-1">
                        				<a href="/{{ config('app.name') }}/setup/tambah file"><button data-toggle="modal" data-target="#modal-insert" class="btn btn-info col-sm-12" style="margin-bottom: 10px">Tambah</button></a>
                        			</div>
                        			<div class="col-md-10">
                            			<form method="GET" action="/{{ config('app.name') }}/setup/file">
											<div class=" col-md-2">
										...
										<table class="myTable table table-hover">
											...
											<tbody style="vertical-align: middle;">
												...
												<tr>
													...
													@if($access['zupd'] == 'y' || $access['zdel'] == 'y')
													<td>
														<form method="GET" action="/{{ config('app.name') }}/setup/ubah file">
														@if($access['zupd'] == 'y')
			...
			<div id="modal-delete" class="modal fade" role="dialog">
				<div class="modal-dialog">
					<div class="modal-content">
						<form method="POST" action="/{{ config('app.name') }}/setup/form/hapusfile" class="form-horizontal">
						@csrf
