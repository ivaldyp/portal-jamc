				...
				<div class="article">
					...
					<div id="home-owl" class="owl-carousel owl-theme">
						<div class="home-item" style="height: 600px">
							<div class="section-bg" style="background-image: url('{{ ('/dasarhukum/public/img/profil/image-01-full.jpg') }}') ; background-size: contain; background-repeat: no-repeat;"></div>
						</div>
						<div class="home-item" style="height: 600px">
							<div class="section-bg" style="background-image: url('{{ ('/dasarhukum/public/img/profil/image-02-full.jpg') }}') ; background-size: contain; background-repeat: no-repeat;"></div>
						</div>
						<div class="home-item" style="height: 600px">
							<div class="section-bg" style="background-image: url('{{ ('/dasarhukum/public/img/profil/image-03-full.jpg') }}') ; background-size: contain; background-repeat: no-repeat;"></div>
						</div>
						<div class="home-item" style="height: 600px">
							<div class="section-bg" style="background-image: url('{{ ('/dasarhukum/public/img/profil/image-04-full.jpg') }}') ; background-size: contain; background-repeat: no-repeat;"></div>
						</div>
						<div class="home-item" style="height: 600px">
							<div class="section-bg" style="background-image: url('{{ ('/dasarhukum/public/img/profil/image-05-full.jpg') }}') ; background-size: contain; background-repeat: no-repeat;"></div>
						</div>
						<div class="home-item" style="height: 600px">
							<div class="section-bg" style="background-image: url('{{ ('/dasarhukum/public/img/profil/image-06-full.jpg') }}') ; background-size: contain; background-repeat: no-repeat;"></div>
						</div>
					</div>
					...
					<div class="article-content">
			            ...
			            <span class='zoom' id='ex2'>
							...
							<img src="{{ ('/dasarhukum/public/img/profil/organisasi2.jpg') }}" width='100%' alt='Struktur Organisasi BPAD'/>
						</span>
			            <br><br>
			            ...
			            <span class='zoom' id='ex1'>
							<img src="{{ ('/dasarhukum/public/img/profil/organisasi_suban2.jpg') }}" width='100%' alt='Struktur Organisasi BPAD'/>
						</span>
			            <br><br>
