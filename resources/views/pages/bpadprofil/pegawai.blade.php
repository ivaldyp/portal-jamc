...
@section('css')
	...
	<!-- xeditable css -->
	<link href="{{ ('/pengamanan/public/ample/plugins/bower_components/x-editable/dist/bootstrap3-editable/css/bootstrap-editable.css') }}" rel="stylesheet" />
	<!-- animation CSS -->
	...
	<div id="page-wrapper">
		<div class="container-fluid">
			...
			<div class="row ">
				<div class="col-md-4">
					<div class="white-box">
								...
								<div class="user-content">
									<!-- <?php if ($emp_data['foto'] && $emp_data['foto'] != '') : ?>
										<?php if ($emp_data['tampilnew'] == 1) : ?>
											<img src="/pengamanan/public/publicimg/{{ $emp_data['foto'] }}" style="height: 150%" class="thumb-lg img-circle" alt="img">
										<?php else : ?>
						...
						<form method="POST" action="/pengamanan/profil/form/ubahidpegawai" data-toggle="validator" enctype="multipart/form-data">
						@csrf
						<div class="user-btm-box" style="text-align: center;">
												...
												<tr>
													...
													<!-- <?php if ($gol['gambar'] && $gol['gambar'] != '') : ?> 
														<?php if ($gol['gambar'] == 1) : ?>
															<td style="vertical-align: middle;">
																<strong>File</strong>
																<br><a target="_blank" href="/pengamanan/public/publicimg/{{ $gol['gambar'] }}"></a>
															</td>
														<?php else : ?>
															<td style="vertical-align: middle;">
																<strong>File</strong>
													...
													<?php if ($gol['gambar'] && $gol['gambar'] != '' && $gol['tampilnew'] == 1) : ?> 
														<td style="vertical-align: middle;">
															<strong>File</strong>
															<br><a target="_blank" href="/pengamanan/public/publicimg/gol/{{ $gol['gambar'] }}"></a>
														</td>
													<?php else : ?>
														<td style="vertical-align: middle;">
															<strong>File</strong>
												...
												<tr>
													...
													<!-- <?php if ($jab['gambar'] && $jab['gambar'] != '') : ?> 
														<?php if ($jab['gambar'] == 1) : ?>
															<td style="vertical-align: middle;">
																<strong>File</strong>
																<br><a target="_blank" href="/pengamanan/public/publicimg/{{ $jab['gambar'] }}"></a>
															</td>
														<?php else : ?>
															<td style="vertical-align: middle;">
																<strong>File</strong>
													...
													<?php if ($jab['gambar'] && $jab['gambar'] != '' && $jab['tampilnew'] == 1) : ?> 
														<td style="vertical-align: middle;">
															<strong>File</strong>
															<br><a target="_blank" href="/pengamanan/public/publicimg/jab/{{ $jab['gambar'] }}"></a>
														</td>
													<?php else : ?>
														<td style="vertical-align: middle;">
															<strong>File</strong>
			...
			<div id="modal-insert-dik" class="modal fade" role="dialog">
				<div class="modal-dialog">
					<div class="modal-content">
						<form method="POST" action="/pengamanan/profil/form/tambahdikpegawai" class="form-horizontal" enctype="multipart/form-data">
						@csrf
			...
			<div id="modal-update-dik" class="modal fade" role="dialog">
				<div class="modal-dialog">
					<div class="modal-content">
						<form method="POST" action="/pengamanan/profil/form/ubahdikpegawai" class="form-horizontal" enctype="multipart/form-data">
						@csrf
							<div class="modal-header">
								<h4 class="modal-title"><b>Ubah Pendidikan</b></h4>
							</div>
			...
			<div class="modal fade" id="modal-delete-dik">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <form method="POST" action="/pengamanan/profil/form/hapusdikpegawai" class="form-horizontal">
                        @csrf
                            <div class="modal-header">
...
@section('js')
	...
	<!-- jQuery x-editable -->
	<script src="{{ ('/pengamanan/public/ample/plugins/bower_components/moment/moment.js') }}"></script>
	<script type="text/javascript" src="{{ ('/pengamanan/public/ample/plugins/bower_components/x-editable/dist/bootstrap3-editable/js/bootstrap-editable.min.js') }}"></script>
