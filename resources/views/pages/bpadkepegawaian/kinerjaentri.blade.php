                    	...
                    	<div class="panel-wrapper collapse in">
                            <div class="panel-body">
                            	<div class="row" style="margin-bottom: 10px">
                            		<div class="col-md-1">
										@if ($access['zadd'] == 'y' && $_SESSION['user_jamcportal']['id_emp'] )
										<form class="form-horizontal" method="POST" action="/{{ config('app.name') }}/kepegawaian/kinerja tambah">
															...
															<tr>
																...
																<td>
																	<div class="col-lg-1 col-md-1 col-sm-1 col-xs-1">
																		<form method="POST" action="/{{ config('app.name') }}/kepegawaian/kinerja tambah">
																			@csrf
																	...
																	<div class="col-lg-1 col-md-1 col-sm-1 col-xs-1">
																		@if($laporan['stat'] != 1)
																		<form method="POST" action="/{{ config('app.name') }}/kepegawaian/form/hapuskinerja">
																			@csrf
