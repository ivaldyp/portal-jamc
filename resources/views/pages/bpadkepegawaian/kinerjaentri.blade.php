                            ...
                            <div class="panel-body">
                            	<div class="row" style="margin-bottom: 10px">
                            		<div class="col-md-1">
										...
										<form class="form-horizontal" method="POST" action="/pengamanan/kepegawaian/kinerja tambah">
															...
															<tr>
																...
																<td>
																	<div class="col-lg-1 col-md-1 col-sm-1 col-xs-1">
																		<form method="POST" action="/pengamanan/kepegawaian/kinerja tambah">
																			@csrf
																	...
																	<div class="col-lg-1 col-md-1 col-sm-1 col-xs-1">
																		@if($laporan['stat'] != 1)
																		<form method="POST" action="/pengamanan/kepegawaian/form/hapuskinerja">
																			@csrf
