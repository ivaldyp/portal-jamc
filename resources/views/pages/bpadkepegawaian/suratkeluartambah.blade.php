	...
	<div id="page-wrapper">
		<div class="container-fluid">
			...
			<div class="row ">
				...
				<div class="col-md-8">
					<form class="form-horizontal" method="POST" action="/bpadwebs/kepegawaian/form/tambahsuratkeluar" data-toggle="validator" enctype="multipart/form-data">
					@csrf
							...
							<div class="panel-wrapper collapse in" aria-expanded="true">
								<div class="panel-body">
									...
									<div class="form-group">
										...
										<div class="col-md-4">
											<input type="text" name="tgl_surat" class="form-control" id="datepicker-autoclose" autocomplete="off" placeholder="dd/mm/yyyy">
										</div>
										<div class="col-md-4">
