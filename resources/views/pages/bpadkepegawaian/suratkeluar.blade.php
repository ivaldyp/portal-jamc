						...
						<div class="panel-wrapper collapse in">
							<div class="panel-body">
								<div class="row " style="margin-bottom: 10px">
									<div class="col-md-1">
										@if ($access['zadd'] == 'y')
										<a href="/pengamanan/kepegawaian/surat keluar tambah"><button class="btn btn-info" style="margin-bottom: 10px">Tambah </button></a> 
										@endif
									</div>
								</div>
								<div class="row">
											...
											<tbody>
												...
												<tr>
													...
													@if($access['zupd'] == 'y' || $access['zdel'] == 'y')
														<td class="col-md-1">
															@if($access['zupd'] == 'y')
																<form method="POST" action="/pengamanan/kepegawaian/surat keluar ubah">
																	@csrf
			...
			<div id="modal-delete" class="modal fade" role="dialog">
				<div class="modal-dialog">
					<div class="modal-content">
						<form method="POST" action="/pengamanan/kepegawaian/form/hapussuratkeluar" class="form-horizontal">
						@csrf
