							...
							<div class="panel-wrapper collapse in" aria-expanded="true">
								<div class="panel-body">
									...
									<div class="content-wrap">
										...
										<form class="form-horizontal" method="POST" action="/produkhukum/kepegawaian/form/ubahpegawai" data-toggle="validator" enctype="multipart/form-data">
										@csrf
											<div class="col-md-12">
											...
											<a href="/produkhukum/kepegawaian/data pegawai"><button type="button" class="m-b-20 m-t-10 btn btn-default pull-right m-r-10"> Kembali </button></a>	
										...
										<section id="section-underline-2">
													...
													<tbody>
														...
														<tr>
																	...
																	<div id="modal-delete-dik-{{$key}}" class="modal fade" role="dialog">
																		<div class="modal-dialog">
																			<div class="modal-content">
																				<form method="POST" action="/produkhukum/kepegawaian/form/hapusdikpegawai" class="form-horizontal">
																				@csrf
															...
															<div id="modal-update-dik-{{$key}}" class="modal fade" role="dialog">
																<div class="modal-dialog">
																	<div class="modal-content">
																		<form method="POST" action="/produkhukum/kepegawaian/form/ubahdikpegawai" class="form-horizontal" enctype="multipart/form-data">
																		@csrf
																			<div class="modal-header">
											...
											<a href="/produkhukum/kepegawaian/data pegawai"><button type="button" class="btn btn-default pull-right m-b-20 m-t-10"> Kembali </button></a>	
										</section>
										<div id="modal-insert-dik" class="modal fade" role="dialog">
											<div class="modal-dialog">
												<div class="modal-content">
													<form method="POST" action="/produkhukum/kepegawaian/form/tambahdikpegawai" class="form-horizontal" enctype="multipart/form-data">
													@csrf
														<div class="modal-header">
														...
														<tr>
															...
															<td>
																	...
																	<div id="modal-delete-gol-{{$key}}" class="modal fade" role="dialog">
																		<div class="modal-dialog">
																			<div class="modal-content">
																				<form method="POST" action="/produkhukum/kepegawaian/form/hapusgolpegawai" class="form-horizontal">
																				@csrf
																					<div class="modal-header">
															...
															<div id="modal-update-gol-{{$key}}" class="modal fade" role="dialog">
																<div class="modal-dialog">
																	<div class="modal-content">
																		<form method="POST" action="/produkhukum/kepegawaian/form/ubahgolpegawai" class="form-horizontal" enctype="multipart/form-data">
																		@csrf
																			<div class="modal-header">
										...
										<div id="modal-insert-gol" class="modal fade" role="dialog">
											<div class="modal-dialog">
												<div class="modal-content">
													<form method="POST" action="/produkhukum/kepegawaian/form/tambahgolpegawai" class="form-horizontal" enctype="multipart/form-data">
													@csrf
														<div class="modal-header">
														...
														<tr>
															...
															<td>
																	...
																	<div id="modal-delete-jab-{{$key}}" class="modal fade" role="dialog">
																		<div class="modal-dialog">
																			<div class="modal-content">
																				<form method="POST" action="/produkhukum/kepegawaian/form/hapusjabpegawai" class="form-horizontal">
																				@csrf
																					<div class="modal-header">
															...
															<div id="modal-update-jab-{{$key}}" class="modal fade" role="dialog">
																<div class="modal-dialog">
																	<div class="modal-content">
																		<form method="POST" action="/produkhukum/kepegawaian/form/ubahjabpegawai" class="form-horizontal" enctype="multipart/form-data">
																		@csrf
																			<div class="modal-header">
										...
										<div id="modal-insert-jab" class="modal fade" role="dialog">
											<div class="modal-dialog">
												<div class="modal-content">
													<form method="POST" action="/produkhukum/kepegawaian/form/tambahjabpegawai" class="form-horizontal" enctype="multipart/form-data">
													@csrf
														<div class="modal-header">
										...
										<section id="section-underline-5">
											<form class="form-horizontal" method="POST" action="/produkhukum/kepegawaian/form/ubahstatuspegawai" data-toggle="validator" enctype="multipart/form-data">
											@csrf
												<div class="col-md-12">
													<input type="hidden" name="id_emp" value="{{ $id_emp }}">
