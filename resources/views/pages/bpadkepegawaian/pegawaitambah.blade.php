							...
							<div class="panel-wrapper collapse in" aria-expanded="true">
								<div class="panel-body">
									...
									<div class="form-group">
										...
										<div class="col-md-4">
											<input type="text" name="nip_emp" class="form-control" id="nip_emp">
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-md-4">
											<input type="text" name="nrk_emp" class="form-control" id="nrk_emp">
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-md-2">
											<input type="text" name="gelar_dpn" class="form-control" id="gelar_dpn" placeholder="Depan">
										</div>
										<div class="col-md-2">
											<input type="text" name="gelar_blk" class="form-control" id="gelar_blk" placeholder="Belakang">
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-md-2">
											<input type="text" name="tempat_lahir" class="form-control" id="tempat_lahir" placeholder="Tempat">
										</div>
										<div class="col-md-2">
											<input type="text" name="tgl_lahir" class="form-control" id="datepicker-autoclose2" placeholder="mm/dd/yyyy">
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-md-4">
											<input type="text" name="tlp_emp" class="form-control" id="tlp_emp">
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-md-4">
											<input type="email" name="email_emp" class="form-control" id="email_emp" data-error="Masukkan alamat email yang valid">
											<div class="help-block with-errors"></div>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-md-4">
											<input type="text" name="cb_bank" class="form-control" id="cb_bank">
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-md-4">
											<input type="text" name="an_bank" class="form-control" id="an_bank">
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-md-4">
											<input type="text" name="nr_bank" class="form-control" id="nr_bank">
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-md-4">
											<input type="text" name="no_taspen" class="form-control" id="no_taspen">
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-md-4">
											<input type="text" name="no_askes" class="form-control" id="no_askes">
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-md-4">
											<input type="text" name="no_jamsos" class="form-control" id="no_jamsos">
										</div>
									</div>
							...
							<div class="panel-wrapper collapse in" aria-expanded="true">
								<div class="panel-body">
									...
									<div class="form-group">
										...
										<div class="col-md-4">
											<input type="text" name="prog_sek" class="form-control" id="prog_sek">
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-md-4">
											<input type="text" name="nm_sek" class="form-control" id="nm_sek">
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-md-3">
											<input type="text" name="no_sek" class="form-control" id="no_sek" placeholder="Nomor Ijazah">
										</div>
										<div class="col-md-1">
											<input type="text" name="th_sek" class="form-control" id="th_sek" placeholder="Tahun">
										</div>
									</div>
									...
									<div class="form-group">
										<label for="gelar" class="col-md-2 control-label"> Gelar </label>
										<div class="col-md-2">
											<input type="text" name="gelar_dpn_sek" class="form-control" id="gelar_dpn_sek" placeholder="Depan">
										</div>
										<div class="col-md-2">
											<input type="text" name="gelar_blk_sek" class="form-control" id="gelar_blk_sek" placeholder="Belakang">
										</div>
									</div>
							...
							<div class="panel-wrapper collapse in" aria-expanded="true">
								<div class="panel-body">
									...
									<div class="form-group">
										...
										<div class="col-md-4">
											<input type="text" name="tmt_gol" class="form-control" id="datepicker-autoclose3" placeholder="mm/dd/yyyy">
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-md-4">
											<input type="text" name="no_sk_gol" class="form-control" id="no_sk_gol">
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-md-4">
											<input type="text" name="tmt_sk_gol" class="form-control" id="datepicker-autoclose4" placeholder="mm/dd/yyyy">
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-md-2">
											<input type="text" name="mk_thn" class="form-control" id="mk_thn" placeholder="Tahun">
										</div>
										<div class="col-md-2">
											<input type="text" name="mk_bln" class="form-control" id="mk_bln" placeholder="Bulan">
										</div>
									</div>
							...
							<div class="panel-wrapper collapse in" aria-expanded="true">
								<div class="panel-body">
									...
									<div class="form-group">
										...
										<div class="col-md-4">
											<input type="text" name="tmt_jab" class="form-control" id="datepicker-autoclose5" placeholder="mm/dd/yyyy">
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-md-4">
											<input type="text" name="no_sk_jab" class="form-control" id="no_sk_jab">
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-md-4">
											<input type="text" name="tmt_sk_jab" class="form-control" id="datepicker-autoclose6" placeholder="mm/dd/yyyy">
										</div>
									</div>
