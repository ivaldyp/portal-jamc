						...
						<div class="panel-wrapper collapse in">
							<div class="panel-body">
								<div class="row" style="margin-bottom: 10px">
									<form method="GET" action="/dasarhukum/kepegawaian/laporan kinerja">
										<div class="col-md-3">
								...
								<div class="row">
									<div class="col-md-12">
										<a href="/dasarhukum/kepegawaian/excel?id={{$now_id_emp}}&month={{$now_month}}&year={{$now_year}}&valid={{$now_valid}}"><button class="btn btn-info"> Excel </button></a>
									</div>
								</div>
								<div class="row">
