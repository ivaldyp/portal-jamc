            ...
            <div class="row ">
                <div class="col-md-12">
                    <div class="panel panel-default">
                        ...
                        <form class="form-horizontal" method="POST" action="/bpadwebs/cms/form/ubahcontent" data-toggle="validator" enctype="multipart/form-data">
                        @csrf   
                            <div class="panel-wrapper collapse in">
                                <div class="panel-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8">
                                            <textarea class="textarea_editor form-control" rows="15" placeholder="Enter text ..." name="isi1">{!! html_entity_decode($content['isi1']) !!}</textarea>
                                        </div>
                                    </div>
                                    @endif
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8">
                                            <textarea class="textarea_editor2 form-control" rows="15" placeholder="Enter text ..." name="isi2">{!! html_entity_decode($content['isi2']) !!}</textarea>
                                        </div>
                                    </div>
                                    @endif
                                ...
                                <div class="panel-footer">
                                    ...
                                    @if($content['appr'] == 'N')
                                    <a href="/bpadwebs/cms/form/apprcontent?ids={{ $content['ids'] }}&idkat={{ $content['idkat'] }}&appr=Y&judul={{ $content['judul'] }}"><button type="button" class="btn btn-success pull-right" style="margin-right: 10px">Setuju</button></a>
                                    @else
                                    <a href="/bpadwebs/cms/form/apprcontent?ids={{ $content['ids'] }}&idkat={{ $content['idkat'] }}&appr=N&judul={{ $content['judul'] }}"><button type="button" class="btn btn-danger pull-right" style="margin-right: 10px">Batal Setuju</button></a>
                                    @endif
